...
export default function AdminUserBalanceViewDialog(props) {
    ...
    return (
        <React.Fragment>
            ...
            <List>
                ...
                <Divider />
                <ListItem button>
                    <ListItemText primary="Balance" secondary={userSelected.userBalance} />
                </ListItem>
            </List>
        </React.Fragment>
    );
...
AdminUserBalanceViewDialog.propTypes = {
